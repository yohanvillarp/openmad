...
window.App.renderHome = function (container) {
    container.innerHTML = `
    <div class="home-university">
      ${window.App.renderUniBanner({
          title: 'Desarrollado para estudiantes de la Universidad Nacional Amazónica de Madre de Dios',
          shortTitle: 'Desarrollado para estudiantes de la UNAMAD',
