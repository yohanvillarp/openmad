...
export const steps_sustentacion_practicas = [
    {
        ...
        guide: {
            ...
            keys: [
                ...
                { code: '3', text: 'Organiza tu preparación según la fecha comunicada.' }
            ],
    ...
    },
    {
        ...
        guide: {
            ...
            keys: [
                ...
                { code: '4', text: 'Generalmente debes llevar una laptop para proyectar. Guarda las diapositivas en la laptop y lleva el cargador y lo que puedas necesitar.' }
            ],
