...
window.App.mocks.stepsByModule['informe-practicas'] = [
    {
        ...
        guide: {
            ...
            keys: [
                ...
                { code: '2', text: 'Guarda una copia con un nombre que te permita identificarla y conservar la plantilla original sin cambios.' },
            ...
            sections: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        'En la portada, escribe las fechas exactas de inicio y fin de las prácticas. Evita periodos ambiguos como “enero–abril”.',
    ...
    },
    {
        ...
        guide: {
            ...
            keys: [
                { code: 'Anexo 01', text: 'Carta de presentación. La obtuviste en “Solicitar carta de presentación”, donde guardaste una copia para el informe.' },
                { code: 'Anexo 02', text: 'Carta de aceptación de prácticas preprofesionales. La recogiste y copiaste en “Solicitar carta de aceptación”.' },
                { code: 'Anexo 03', text: 'Carta de compromiso de conducta ética y profesional. La completaste y guardaste al solicitar la carta de aceptación.' },
                { code: 'Anexo 04', text: 'Ficha de evaluación de las prácticas preprofesionales. El asesor la completó durante la visita y la conservaste después de realizar el paso “Coordinar con el asesor”.' },
                { code: 'Anexo 05', text: 'Certificado o constancia de prácticas emitido por la entidad. Lo obtuviste en “Solicitar el certificado o constancia de prácticas” y debe incluir las fechas, horas, firma y sello correspondientes.' }
            ],
    ...
    },
    {
        ...
        guide: {
            hint: 'Utiliza una cuenta de correo a la que tengas acceso frecuente y conserva el mensaje enviado.',
            email: 'fingenieria@unamad.edu.pe',
            emailLabel: 'Escribir a fingenieria@unamad.edu.pe',
            ...
            keys: [
                ...
                { code: '2', text: 'Abre un correo nuevo dirigido a <strong>fingenieria@unamad.edu.pe</strong>, correo institucional de la Facultad de Ingeniería.' },
                { code: '3', text: 'Escribe este asunto y reemplaza los campos entre llaves:<br><strong>PRESENTACIÓN DE INFORME FINAL DE PRÁCTICAS PRE-PROFESIONALES - {CÓDIGO DE ESTUDIANTE} - {APELLIDOS} {NOMBRES}</strong>' },
                { code: '4', text: 'Copia este mensaje y completa tus datos:<br><br>Mediante el presente correo, saludo cordialmente a su despacho y solicito el trámite de revisión y aprobación de mi Informe Final de Prácticas Pre-Profesionales I, de conformidad con el reglamento vigente de la Escuela Profesional.<br><br><strong>Estudiante:</strong> {APELLIDOS Y NOMBRES}<br><strong>Código de estudiante:</strong> {CÓDIGO}<br><strong>Escuela Profesional:</strong> Ingeniería de Sistemas e Informática<br><strong>Número de celular:</strong> {NÚMERO DE CELULAR}<br><strong>Lugar de desarrollo de prácticas:</strong> {NOMBRE DE LA ENTIDAD}' },
                ...
                { code: '6', text: 'Envía el correo y conserva una copia del mensaje. La Facultad podría no enviar una confirmación automática; es posible que la siguiente comunicación llegue al concluir la revisión. Según el reglamento, la Comisión dispone de hasta <strong>15 días hábiles</strong> para emitir el dictamen y, en caso de sobrecarga, puede solicitar formalmente una ampliación de hasta <strong>10 días hábiles adicionales</strong>.' },
                { code: '7', text: 'Revisa el dictamen cuando lo recibas. Si contiene observaciones, corrige el informe y vuelve a enviarlo dentro del plazo comunicado, sin exceder <strong>5 días hábiles</strong>. Si el mensaje no indica un plazo, cumple el máximo de 5 días hábiles establecido por el reglamento. La revisión de las correcciones debe resolverse dentro del plazo general de evaluación o de la prórroga formalmente comunicada.' }
            ],
