...
window.App.renderProgress = function (progress) {
    ...
    const stats = progress || window.App.getGraphProgress();
...
window.App.animateProgress = function (payload) {
    const result = payload || {};
    const before = result.before || window.App.getGraphProgress();
    const after = result.after || window.App.getGraphProgress();
    const unlocked = result.unlocked || {};
    const restored = result.restored || {};

    window.App.renderProgress(before);
